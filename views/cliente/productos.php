                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="portal-card h-100 d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <span class="badge bg-light text-primary fw-semibold">Bs <?= number_format((float) ($producto['precio_metro'] ?? $producto['precio_desde'] ?? $producto['precio']), 2); ?> <small class="text-muted">por metro</small></span>
                        </div>
